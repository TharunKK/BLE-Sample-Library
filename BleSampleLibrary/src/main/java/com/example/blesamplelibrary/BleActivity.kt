...
import com.example.blesamplelibrary.BluetoothLeService.Companion.ACTION_GATT_SERVICES_DISCOVERED
import com.example.blesamplelibrary.Utils.LED_BLUE
import com.example.blesamplelibrary.Utils.LED_RED
import com.example.blesamplelibrary.Utils.THINGY_UI_SERVICE


private const val ENABLE_BLUETOOTH_REQUEST_CODE = 1
private const val RUNTIME_PERMISSION_REQUEST_CODE = 2

class BleActivity : AppCompatActivity(), ScanAdapter.ScanListener {
        ...
        override fun onReceive(context: Context, intent: Intent) {
            when (intent.action) {
                BluetoothLeService.ACTION_GATT_CONNECTED -> {
                    //connected = true
                    Toast.makeText(this@BleActivity, "Connected", Toast.LENGTH_LONG)
                    Log.i("BleConnection", "Connected")
                }

                BluetoothLeService.ACTION_GATT_DISCONNECTED -> {
                    //connected = false
                    Toast.makeText(this@BleActivity, "Disconnected", Toast.LENGTH_LONG)
                    Log.i("BleConnection", "Disconnected")
                }

                BluetoothLeService.ACTION_GATT_SERVICES_DISCOVERED -> {
                    Toast.makeText(this@BleActivity, "Service Discovered", Toast.LENGTH_LONG)
    ...
    private fun promptEnableBluetooth() {
        if (!bluetoothAdapter.isEnabled) {
            ...
            if (ActivityCompat.checkSelfPermission(
                ...
                Toast.makeText(this@BleActivity, "Bluetooth not connected", Toast.LENGTH_LONG)
